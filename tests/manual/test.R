...
page_session$.__enclos_env__$private$.CDPSession_con$connect()

# listening event
page_session$on("Runtime.executionContextCreated", function(...) cat("First command passed!"))
...
page_session$on('Page.domContentEventFired',
...
page_session$on('Runtime.bindingCalled',
