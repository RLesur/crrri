...
The problem we face with R Markdown is that the `rmarkdown::render()` function does not wait for the promise resolution: there is no output in the rendered document.
